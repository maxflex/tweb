<div class="address-info-block address-info-block_all">
    <div class="header-3">
    ...
    <div class="flex-items">
        ...
        ></div>
        <a
            href="whatsapp://send?phone=+{{ \App\Service\Phone::clean($maps['len']['mobile']) }}"
        >
            {{ $maps["len"]["mobile"] }}
        </a>
    </div>
    <div class="flex-items">
        ...
        ></div>
        <a
            href="viber://chat?number=+{{ \App\Service\Phone::clean( $maps['len']['mobile'] ) }}"
        >
            {{ $maps["len"]["mobile"] }}
        </a>
    </div>
    ...
    <div class="flex-items">
        ...
        ></div>
        <a
            href="whatsapp://send?phone=+{{ \App\Service\Phone::clean($maps['pol']['mobile']) }}"
        >
            {{ $maps["pol"]["mobile"] }}
        </a>
    </div>
    <div class="flex-items">
        ...
        ></div>
        <a
            href="viber://chat?number=+{{ \App\Service\Phone::clean( $maps['pol']['mobile'] ) }}"
        >
            {{ $maps["pol"]["mobile"] }}
        </a>
    </div>
    ...
    <div class="flex-items">
        ...
        ></div>
        <a
            href="whatsapp://send?phone=+{{ \App\Service\Phone::clean($maps['delegat']['mobile']) }}"
        >
            {{ $maps["delegat"]["mobile"] }}
        </a>
    </div>
    <div class="flex-items">
        ...
        ></div>
        <a
            href="viber://chat?number=+{{ \App\Service\Phone::clean( $maps['delegat']['mobile'] ) }}"
        >
            {{ $maps["delegat"]["mobile"] }}
        </a>
    </div>
