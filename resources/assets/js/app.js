...
(function() {
  angular.module('App').controller('main', function($scope, $timeout, $http, GalleryService, VideoService) {
    var initGmap;
    bindArguments($scope, arguments);
...
(function() {
  angular.module('App').controller('master', function($scope, $timeout, $http, Master, GalleryService, VideoService) {
    bindArguments($scope, arguments);
    VideoService.init();
