            ...
            image.onload = function () {
              scope.$apply(function () {
                if (attributes.asyncKind == "thumb") {
                  element.css({
                    backgroundImage: 'url("' + attributes.showImageAsync + '")',
                  });
          ...
          link: function (scope, element, attributes) {
            var indexCalc = function () {
              console.log(
                ...
                scope._bubblesInView,
                scope.images.length
              );
              var jump_width = 175;
              var coeff =
                scope._activeImageIndex -
                (Math.round(scope._bubblesInView / 2) - 1);
      ...
      function ($rootScope, $timeout, $q, ngImageGalleryOpts) {
        return {
          ...
          templateUrl: function (elem, attrs) {
            return isMobile
              ? "/directives/image-gallery-mobile"
              : "/directives/image-gallery";
          },
          link: {
            pre: function (scope, elem, attr) {
              ...
              scope.$watchCollection("conf", function (conf) {
                ...
                scope.errorPlaceHolder =
                  conf.errorPlaceHolder != undefined
                    ? conf.errorPlaceHolder
                    : scope.errorPlaceHolder != undefined
                    ? scope.errorPlaceHolder
                    : ngImageGalleryOpts.errorPlaceHolder;
              });

              scope.onOpen =
                scope.onOpen != undefined ? scope.onOpen : angular.noop;
              scope.onClose =
                scope.onClose != undefined ? scope.onClose : angular.noop;
              scope.onDelete =
              ...
              scope.methods.next = function () {
                ...
                eventAction(
                  prefixEvent("photogallery-right"),
