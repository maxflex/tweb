...
class Parser
{
    ...
    public static function compileVars($html, $page = null)
    {
        ...
        foreach ($vars as $var) {
            ...
            $ssrParser = new SsrParser($var, static::$page);
            if ($ssrParser->exists()) {
    ...
    public static function compileMaster($id, &$page)
    {
        ...
        static::replace($html, 'current_master_review_ids', Review::where('master_id', $master->id)->orderBy('date', 'desc')->pluck('id')->implode(','));
